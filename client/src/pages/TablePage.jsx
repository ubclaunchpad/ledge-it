...
const expenseDatabase = [{name: 'Gym', 
                          price: '65.00', 
...
const incomeDatabase = [{name: 'Part Time: Piano Lessons', 
                          price: '650.00', 
                          date: new Date("2021-10-21T10:34:23"),
                          currency: 'CAD',
                          category: 'Category #1'
...
const TablePage = () => {
  ...
  return (
    <>
      ...
      onValueChange = {(chosenValue) => {setPickerValue(chosenValue)}}>
        <Picker.Item label = "Expenses" value = "Expenses"/>
        <Picker.Item label = "Income" value = "Income"/>
      </Picker>
      {pickerValue =='Expenses'
          ? <ScrollTable renderList ={splitExpenses} type = {pickerValue}></ScrollTable> 
          : <ScrollTable renderList ={splitIncome} type = {pickerValue}></ScrollTable> 
      }
    </>
  );
};
