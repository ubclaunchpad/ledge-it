...
const BudgetTableComponent = ({budget, index, isVisible, setVisible, setMonth, setYear}) => {
    return (
        <>
            <List.Item
            key={index}
            ...
            onPress = {() => {setVisible(!isVisible), setMonth(MONTHS[budget.month]), setYear(budget.year) }}
