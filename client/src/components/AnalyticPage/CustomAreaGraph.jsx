...
const CustomAreaGraph = ({ dateStringData, dateData }) => {
  ...
  const handleRangeChange = (newBounds) => {
    ...
    let lowerBoundString = lowerBound.toLocaleDateString("en-US", options);
    ...
    let filteredData = dateData.filter((row) => 
      row["x"] >= lowerBound
    )
  ...
  const displayPrice = (scaleX, x, scaleY, y) => {
    let date = scaleX.invert(x).toISOString().split('T')[0];
    let data = dateStringData.find((obj) => obj.x === date);
    if (data !== undefined){
    ...
    <View style={styles.container}>
      <View style={styles.container}>
        ...
        <SlideAreaChart
            ...
            shouldCancelWhenOutside={false}yo
            data={dateData}
            height = {325}
            axisWidth={0}
            axisHeight={0}
        ...
        <DataTable style = {{backgroundColor: "#24838F", paddingBottom: 10}}>
          <DataTable.Row>
            <DataTable.Cell numeric>
              <Button 
                style = {{backgroundColor: selectedRange === "1W" ? "#00ABF0" : "#24838F", borderRadius: 20}}
                color='white'
            ...
            <DataTable.Cell numeric>
              <Button
                style = {{backgroundColor: selectedRange === "1M" ? "#00ABF0" : "#24838F", borderRadius: 20}}
                color='white'
            ...
            <DataTable.Cell numeric>
              <Button
                style = {{backgroundColor: selectedRange === "3M" ? "#00ABF0" : "#24838F", borderRadius: 20}}
                color='white'
            ...
            <DataTable.Cell numeric>
              <Button
                style = {{backgroundColor: selectedRange === "1Y" ? "#00ABF0" : "#24838F", borderRadius: 20}}
                color='white'
            ...
            <DataTable.Cell numeric>
              <Button
                style = {{backgroundColor: selectedRange === "2Y" ? "#00ABF0" : "#24838F", borderRadius: 20}}
                color='white'
            ...
            <DataTable.Cell numeric>
              <Button
                style = {{backgroundColor: selectedRange === "All" ? "#00ABF0" : "#24838F", borderRadius: 20}}
                color='white'
